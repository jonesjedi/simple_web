...
var (
	...
	ErrUploadFileFailed   = StandardError{11019, "file invalid"}
	ErrUserIsNotConfirmed = StandardError{11020, "user is not confirmed"}
	ErrUserIsSensitive    = StandardError{11021, "user name is sensitive"}
)
